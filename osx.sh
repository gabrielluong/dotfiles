...
sudo scutil --set ComputerName "oracle"
sudo scutil --set HostName "oracle"
sudo scutil --set LocalHostName "oracle"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "oracle"
